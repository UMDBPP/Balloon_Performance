...
%Modified By Michael Walker
    ...
    function hs = addcomponents()
        ...
        hs.fig = figure(...
        'Units','characters',...
        'Position',[3.0 3.0 170 55.5],... %position =[left bottom width height] edit this line to fit on screen
        'Visible','on',...
...
%          ,...
        ...
        'ColumnEditable',true,...
        'ColumnFormat',{ [] [] [] [] []},...
        'Data',{'Balloon',true,1.6,3.5274,1;'Helios',true,1.0206,2.2500,2;'Parachute',true,.9255,2.0404,3;'Command',true,1.5966,3.5200,4;'String',true,0.0830,.1829,5;'Payload 1',true,.4536,1,6;'Payload 2',true,.4536,1,7;'Payload 3',true,.4536,1,8;'Payload 4',true,.4536,1,9;'Payload 5',true,.4536,1,10;'Payload 6',true,.4536,1,11;'Payload 7',true,.4536,1,12;'Payload 8',true,.4536,1,13;'Payload 9',true,.4536,1,14;'Payload 10',true,.4536,1,15},...
        'Children',[],...
        'Tag','PayloadTable',...
        'UserData',[]...
         );
        ...
        hs.PayloadMCalcW = uicontrol(...
        'Parent',hs.PayloadTablePanel,...
        'FontUnits',get(0,'defaultuicontrolFontUnits'),...
        'Units','characters',...
        'String','Use Mass Calc Weight',...
        'Position',[19 2 23 1.5],...
        'Children',[],...
        'Tag','PayloadCalcMW'...
         );
        hs.PayloadWCalcM = uicontrol(...
        'Parent',hs.PayloadTablePanel,...
        'FontUnits',get(0,'defaultuicontrolFontUnits'),...
        'Units','characters',...
        'String','Use Weight Calc Mass',...
        'Position',[43 2 23 1.5],...
        'Children',[],...
        'Tag','PayloadCalcWM'...
         );
...
%     end
    ...
    % initalized
        ...
        set(hs.PayloadMCalcW,'Callback',{@MassCalcWeight,hs});
        set(hs.PayloadWCalcM,'Callback',{@WeightCalcMass,hs});
    ...
    function MassCalcWeight(~,~,hs)
        MassList = cell2mat(hs.PayloadTable.Data(:,3));
        WeightList_N = MassList.*9.80665;
        WeightList_lb = unitconverter(WeightList_N,'N','lb');

        hs.PayloadTable.Data(:,4) = num2cell(WeightList_lb);
    end

    function WeightCalcMass(~,~,hs)
        WeightList_lb = cell2mat(hs.PayloadTable.Data(:,4));
        WeightList_N = unitconverter(WeightList_lb,'lb','N');
        MassList = WeightList_N./9.80665;
        
        hs.PayloadTable.Data(:,3) = num2cell(MassList);
    end

    function PayloadPositionChange(~,~,hs)
        newPositions = cell2mat(hs.PayloadTable.Data(:,5));
        newTable = hs.PayloadTable.Data(newPositions,:);
        hs.PayloadTable.Data = newTable; 
    end
